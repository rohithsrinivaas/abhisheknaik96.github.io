path = 'images/LFI/Die_ans/shiftAdd_'
    ...
    $( "#slider-vertical" ).slider({
      ...
      slide: function( event, ui ) {
        ...
        re_img_tag.onload = function(){
          document.querySelector('#dispLayerFA').style.backgroundImage = 'url("' + path + (Math.floor(sliderValue/10)+1) + ".png" + '")';
        }
        re_img_tag.src = path + (Math.floor(sliderValue/10)+1) + ".png";
      }
    });
...
$(document).ready(function(e) {
  ...
  $('#img-selector').click(function(e) {
      ...
      img_tag.onload = function(){
        document.querySelector('#dispLayer').style.backgroundImage = 'url("' + 'images/LFI/Die_LF/lf_F_' + (newY) + "_" + (newX) + ".png" + '")';
      }
      img_tag.src = 'images/LFI/Die_LF/lf_F_' + (newY) + "_" + (newX) + ".png";
