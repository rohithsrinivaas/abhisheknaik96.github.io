...
var path = 'images/LFI/stanford_truck_fa_ans/img_';
    ...
    $( "#slider-vertical" ).slider({
      ...
      slide: function( event, ui ) {
        ...
        re_img_tag.onload = function(){
          document.querySelector('#dispLayerFA').style.backgroundImage = 'url("' + path + Math.floor(sliderValue/20) + ".png" + '")';
        }
        re_img_tag.src = path + Math.floor(sliderValue/20) + ".png";
      }
    });
    ...
    $( "#slider-hz" ).slider({
      ...
      slide: function( event, ui ) {
        ...
        if(ui.value == 1){
          ...
          document.querySelector('#dispLayerFA').style.backgroundImage = 'url("' + 'images/LFI/stanford_truck_fa_ans/img_3' + ".png" + '")';
          //change the display
          ...
          $( "#slider-vertical" ).slider({
            ...
            slide: function( event, ui ) {
              ...
              var sliderValue = ui.value;
              re_img_tag.onload = function(){
                document.querySelector('#dispLayerPA').style.backgroundImage = 'url("' + 'images/LFI/Stopdown_truck/Img_' + Math.floor(sliderValue/10) + ".png" + '")';
              }
              re_img_tag.src = 'images/LFI/Stopdown_truck/Img_' + Math.floor(sliderValue/10) + ".png";
            }
          });
          document.querySelector('#dispLayerPA').style.backgroundImage = 'url("' + 'images/LFI/Stopdown_truck/Img_1' + ".png" + '")';
          //change the display
...
$(document).ready(function(e) {
  ...
  $('#img-selector').click(function(e) {
      ...
      img_tag.onload = function(){
        document.querySelector('#dispLayer').style.backgroundImage = 'url("' + 'images/LFI/stanford_truck_0.4/out_' + (newY+1) + "_" + (newX+1) + ".png" + '")';
      }
      img_tag.src = 'images/LFI/stanford_truck_0.4/out_' + (newY+1) + "_" + (newX+1) + ".png";
...
function init(){
  ...
  for(ii=1;ii<16;ii++){
    for(jj=1;jj<16;jj++){
      var Img = new Image();
      Img.src = 'images/LFI/stanford_truck_0.4/out_' + (jj) + "_" + (ii) + ".png";
    }
  }

  for(ii=0;ii<8;ii++){
    var Img = new Image();
    Img.src = 'images/LFI/stanford_truck_fa_ans/img_' + (ii) + ".png";
  }
}
