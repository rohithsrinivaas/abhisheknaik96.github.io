var path = 'images/LFI/CD_LF/lf_F_';
    ...
    $( "#slider-vertical" ).slider({
      ...
      slide: function( event, ui ) {
        ...
        re_img_tag.onload = function(){
          document.querySelector('#dispLayerFA').style.backgroundImage = 'url("' + 'images/LFI/CD_ans/shiftAdd_' + Math.floor(sliderValue/10) + ".png" + '")';
        }
        re_img_tag.src = 'images/LFI/CD_ans/shiftAdd_' + Math.floor(sliderValue/10) + ".png";
      }
    });
...
$(document).ready(function(e) {
  ...
  $('#img-selector').click(function(e) {
      ...
      img_tag.onload = function(){
        document.querySelector('#dispLayer').style.backgroundImage = 'url("' + path + (newY-8) + "_" + (newX) + ".png" + '")';
      }
      img_tag.src = path + (newY-8) + "_" + (newX) + ".png";
...
function init(){
  ...
  for(ii=0;ii<21;ii++){
    for(jj=0;jj<5;jj++){
      var Img = new Image();
      Img.src = path + (jj) + "_" + (ii) + ".png";
    }
  }

  for(ii=0;ii<12;ii++){
    var Img = new Image();
    Img.src = 'images/LFI/CD_ans/shiftAdd_' + (ii) + ".png";
  }
}
